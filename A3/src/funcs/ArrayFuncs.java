...
/**
 * Class with a bunch of useful functions for working with bytes
 */
public class ArrayFuncs {

    public static byte[] concatByteArrs(byte[] first, byte[]... rest) {
    ...
    public static byte[] concatenateBytes(byte[] a, int aStart, byte[] b) {
        int bLength = b.length;
        int endLength = aStart + bLength;

        if (endLength <= a.length) {
            for (int i = aStart; i < endLength; i++) {
                a[i] = b[i - aStart];
            }
        } else {
            System.out.println("DERP " + endLength + " a:" + a.length);
        }
        return a;
    }

    /**
     * Finds out if array is populated by only specified value
     *
     * @param a
     * @param value
     * @return
     */
    public static boolean isByteArrByte(byte[] a, byte value) {
    ...
    public static <E> E[] concatenate2(E[] a, int aStart, E[] b) {
        int bLength = b.length;
        int endLength = aStart + bLength;
        if (endLength < a.length) {
            for (int i = aStart; i < endLength; i++) {
    ...
    /* ========================= */
    public static byte[] toByteArr(short data) {
        return new byte[]{
            (byte) ((data >> 8) & 0xff),
            (byte) ((data >> 0) & 0xff),};
    }
    ...
    public static byte[] toByteArr(short[] data) {
        ...
        for (int i = 0; i < data.length; i++) {
            System.arraycopy(toByteArr(data[i]), 0, byts, i * 2, 2);
        }
        return byts;
    }

    /* ========================= */
    public static byte[] toByteArr(char data) {
        return new byte[]{
            (byte) ((data >> 8) & 0xff),
            (byte) ((data >> 0) & 0xff),};
    }
    ...
    public static byte[] toByteArr(int[] data) {
        ...
        for (int i = 0; i < data.length; i++) {
            System.arraycopy(toByteArr(data[i]), 0, byts, i * 4, 4);
        }
        return byts;
    }
    ...
    public static byte[] toByteArr(long[] data) {
        ...
        for (int i = 0; i < data.length; i++) {
            System.arraycopy(toByteArr(data[i]), 0, byts, i * 8, 8);
        }
        return byts;
    }

    /* ========================= */
    public static byte[] toByteArr(float data) {
        return toByteArr(Float.floatToRawIntBits(data));
    }
    ...
    /* ========================= */
    public static byte[] toByteArr(double data) {
        return toByteArr(Double.doubleToRawLongBits(data));
    }
    ...
    /* ========================= */
    public static byte[] toByteArr(boolean data) {
    ...
    public static byte[] toByteArr(boolean[] data) {
        ...
        // ----------
        int len = data.length;
        byte[] lena = toByteArr(len); // int conversion; length array = lena
    ...
    /* ========================= */
    public static byte[] toByteArr(String data) {
    ...
    public static byte[] toByteArr(String[] data) {
        ...
        // ----- arrays:
        byte[] dLen = toByteArr(data.length); // byte array of data length
        ...
        byte[] bsLens = toByteArr(sLens); // byte version of String sLens
